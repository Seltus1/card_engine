...
class PokerGame:
    ...
    def call_bet(self, player: Poker_Player) -> None:
        ...
        print()
        print(f"{player.name} called ${self.call_amount}")
        ...
        while curr_state != Poker_Game_State.GAMEOVER:
            ...
            match curr_state:
                ...
                case Poker_Game_State.WINNER:
                    self.winner()
                    curr_state = Poker_Game_State.GAMEOVER # TODO: Make this a loop so we can play again state.DEAL, game over is when 1 player left
